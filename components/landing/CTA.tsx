      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-white/50 max-w-xl mx-auto mb-10">{t.subtitle}</p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/dashboard" className="btn-primary text-lg px-10 py-4 glow-brand inline-flex items-center gap-2 group">
                {t.cta}
                <svg className="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                </svg>
              </Link>
              <p className="text-white/30 text-sm">{t.sub}</p>
            </div>
          </div>
        </motion.div>
      </div>
